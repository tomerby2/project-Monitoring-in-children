...
ii=[1:145,147:256,258:length(cut_info)];
...
xlabel('avarege distances between R pulses in time intervals');
...
xlabel('variance of the avarege distances between R pulses in time intervals');
